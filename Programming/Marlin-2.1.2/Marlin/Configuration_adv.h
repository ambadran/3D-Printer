 ...
 */
//#define CONFIG_EXPORT 2 // :[1:'JSON', 2:'config.ini', 3:'schema.json', 4:'schema.yml']  // WANTED!!!!!!!!!!!!!!!!!
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 50  // NEWLY ADDED !!!!!!!!!!!! I assume this is in seconds
 ...
 */ // IMPORTANT!!!!!!!!!!!!!!! I think this setting may benefit me
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 2000       // (ms) Total Duration to display the boot screen(s) // NEWLY ADDED!!!! changed from 4000 to 2000
